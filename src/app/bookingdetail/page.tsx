    ...
    <div className="w-full min-h-screen relative bg-gray-50">
      ...
      <div className="flex min-h-[calc(100vh-56px)]">
        ...
        <main className="flex-1 p-4 md:p-7 flex flex-col gap-5 overflow-auto">
          <div className="bg-white rounded-lg p-4 md:p-5 flex flex-col gap-5">
            ...
            <div className="flex flex-col md:flex-row gap-5">
              <div className="flex-1 bg-white rounded-lg p-2.5 flex flex-col gap-2.5">
                ...
                <div className="text-black text-lg font-semibold">Centara Grand Mirage Beach Resort Pattaya</div>
                <div className="flex gap-2">
                  <span className="px-2 py-0.5 bg-blue-100 text-blue-800 rounded-full text-xs font-medium">10.0</span>
                  <span className="text-xs text-blue-800">Excellent</span>
                </div>
              </div>

              <div className="flex-1 flex flex-col gap-2.5">
                <div className="bg-white rounded-lg p-4 md:p-5 outline outline-1 outline-gray-200">
                  <div className="text-xl font-bold text-black">Guest Name</div>
                  <div className="h-9 p-2.5 bg-white rounded-lg text-base font-medium text-black">Emily Chow</div>
                </div>
                <div className="bg-white rounded-lg p-4 md:p-5 outline outline-1 outline-gray-200 flex flex-col gap-2.5">
          ...
          <div className="bg-white rounded-lg p-4 md:p-6 flex flex-col gap-2.5">
          ...
          <div className="self-stretch px-4 md:px-6 py-4 bg-custom-white rounded-[10px] inline-flex flex-row justify-center items-center gap-2.5">        
            <button className="h-10 w-full md:w-50 px-5 bg-red-500 text-white font-bold rounded-2xl shadow-md hover:bg-red-600">
              Cancel Booking
            </button>
            <button className="h-10 w-full md:w-50 px-5 bg-blue-500 text-white font-bold rounded-2xl shadow-md hover:bg-blue-700">
              View your bookings
            </button>
          </div>
        </main>
